...
public class SkillInfoActivity extends BaseActivity{
    ...
    private void init() {
        ...
        try {//拼接post提交参数
            builder1
                    //什么时候使用URLEncoder， 参数有中文时， 有特殊字符时， 如密码之类的
...
//                    .append("appId=").append(params.getString("appId")).append("&")
                    .append("id=").append(URLEncoder.encode(params.getString("id"), "UTF-8"))
//                    .append("id=").append(params.getString("id"))
                    .append("&")
                    .append("latitude=").append(params.getString("latitude"))
                    .append("&")
                    .append("longitude=").append(params.getString("longitude"))
            ;
