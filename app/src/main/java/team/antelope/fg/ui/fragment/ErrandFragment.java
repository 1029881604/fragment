...
public class ErrandFragment extends BaseNearbyFragment<String, NearbyInfo>{
        ...
        v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(type == FORWARD_SKILL){
                    ...
                    intent.putExtra(SkillAndNeedConst.TYPE, SkillAndNeedConst.SKILL_TYPE_ERRAND);
                } else if(type == FORWARD_TASK) {
                    intent = new Intent(FgApp.getInstance().getApplicationContext(), AsyncNeedActivity.class);
                    intent.putExtra(SkillAndNeedConst.TYPE, SkillAndNeedConst.NEED_TYPE_ERRAND);
                }
...
//                view.setvisibililty(view.gone);  设置加载图片消失
    ...
    public void setmType() {
        mType = SkillAndNeedConst.TYPE_ERRAND;
    }
