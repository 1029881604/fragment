...
public class PagerFragmentExa extends BaseFragment implements View.OnClickListener {
    ...
    protected void initView(View view, Bundle savedInstanceState) {
        ...
        for (int i=0; i<publishSkills.size(); i++) {
            if ((publishSkills.get(i).getSkillType().equals("动画制作"))&&!publishSkills.get(i).isOnline()&&
