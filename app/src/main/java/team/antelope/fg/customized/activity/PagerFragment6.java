...
public class PagerFragment6 extends BaseFragment implements View.OnClickListener {
    ...
    private void initLayoutView() {
        ...
        Observable<List<PublishSkill>> observable = RetrofitServiceManager.getInstance()
                .create(CustmoizedBusiness.class).getList(endUrl,
                        SkillAboutDetails.SKILLTYPE6).observeOn(AndroidSchedulers.mainThread())
            ...
            public void onCompleted() {
                ...
                for (int i=0; i<publishSkills.size(); i++) {
                    if (!publishSkills.isEmpty()&&
                            publishSkills.get(i).getSkillType().equals(SkillAboutDetails.SKILLTYPE6)&&
